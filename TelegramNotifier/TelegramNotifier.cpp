...
// TelegramNotifier.cpp : Defines the class behaviors for the application.
//
...
// CTelegramNotifierApp

BEGIN_MESSAGE_MAP(CTelegramNotifierApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CTelegramNotifierApp construction

CTelegramNotifierApp::CTelegramNotifierApp()
{
...
// The one and only CTelegramNotifierApp object

CTelegramNotifierApp theApp;


// CTelegramNotifierApp initialization

BOOL CTelegramNotifierApp::InitInstance()
{
